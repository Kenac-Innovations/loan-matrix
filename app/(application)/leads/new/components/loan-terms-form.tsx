  ...
  useEffect(() => {
    if (loanTemplate) {
      try {
        ...
        setError(err instanceof Error ? err.message : 'Failed to populate form with template data');
      } finally {
        setIsLoading(false);
      }
    }
      ...
      <form onSubmit={form.handleSubmit(handleSubmit as any)} className="space-y-8">
        ...
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-4">Principal</h3>
        ...
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-4">Term Options</h3>
        ...
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-4">Repayments</h3>
        ...
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-4">Repaid Every</h3>
        ...
        {/* Nominal Interest Rate Section */}
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-4">Nominal Interest Rate</h3>
        ...
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-4">Loan Schedule</h3>
        ...
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-4">Interest Calculations</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="interestCalculationPeriod" className="text-sm font-medium">
                  Interest calculation period <span className="text-red-500">*</span>
                </Label>
                <Controller
                  control={form.control}
        ...
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-4">Moratorium</h3>
        ...
        {/* Recalculate Interest Section */}
        <div className="space-y-4">
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-4">Recalculate Interest</h3>
